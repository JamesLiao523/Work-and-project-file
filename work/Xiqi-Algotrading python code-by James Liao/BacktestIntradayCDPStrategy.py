...
# 引入策略類別
from xqctrader.Strategies.CDPStrategy import CDPStrategy as Strategy# 統計套利策略
# 引入Redis來連接自建的即時報價
...
def runBacktest(symbol, data, days):
    ...
    strategy = Strategy(datahandler, eventmanager, point_multiplier, type_dict, start_end=[start_time, end_time], estimation_interval=estimation_interval, dataFreq=DataFreq.Intraday, tradeStatus=TradeStatus.BacktestIntraday)
