...
#   Example:
#   >>TutorialDrive -d 2a 5c -c
#
import TutorialApp, TutorialData
## Read in simulation data
oData = TutorialData.TutorialData()	
    
## Construct an application object
app = TutorialApp.TutorialApp(oData)
    
import sys
# parse command line arguments 
app.ParseCommandLine(sys.argv)
...
try: 
    ...
    app.Tutorial_7c()	    # Risk Budgeting - Addiditve Definition
...
except 'Optimizer license error':
    print('Optimizer license error')
